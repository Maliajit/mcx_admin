<aside class="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <a href="{{ url('/admin/users') }}"
            class="menu-item {{ Request::is('admin/users') && !request('requests') ? 'active' : '' }}">
            <i class="fa fa-users"></i>
            <span>All Users</span>
        </a>
        <a href="{{ url('/admin/users/requests') }}"
            class="menu-item {{ Request::is('admin/users/requests') ? 'active' : '' }}">
        ...
        <a href="{{ url('/admin/orders') }}"
            class="menu-item {{ Request::is('admin/orders') && !Request::is('admin/orders/pending') && !Request::is('admin/orders/completed') ? 'active' : '' }}">
            <i class="fa fa-shopping-cart"></i>
            <span>All Orders</span>
        </a>
        <a href="{{ url('/admin/orders/pending') }}"
            class="menu-item {{ Request::is('admin/orders/pending') ? 'active' : '' }}">
            <i class="fa fa-clock"></i>
            <span>Pending Settlements</span>
        </a>
        <a href="{{ url('/admin/orders/completed') }}"
            class="menu-item {{ Request::is('admin/orders/completed') ? 'active' : '' }}">
        ...
        <a href="{{ url('/admin/rates/gold') }}"
            class="menu-item {{ Request::is('admin/rates/gold') ? 'active' : '' }}">
            <i class="fa fa-coins"></i>
            <span>Gold Rate</span>
        </a>
        <a href="{{ url('/admin/rates/silver') }}"
            class="menu-item {{ Request::is('admin/rates/silver') ? 'active' : '' }}">
            <i class="fa fa-solid fa-circle-notch"></i>
            <span>Silver Rate</span>
        </a>

        <div class="menu-label">Data & Reports</div>
        <a href="{{ url('/admin/reports/history') }}"
            class="menu-item {{ Request::is('admin/reports/history') ? 'active' : '' }}">
            <i class="fa fa-file-alt"></i>
            <span>Order History</span>
        </a>

        <div class="menu-label">Content</div>
        <a href="{{ route('admin.news.index') }}" class="menu-item {{ Request::is('admin/news*') ? 'active' : '' }}">
